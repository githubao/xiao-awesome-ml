...
from xiaolearn.simi.similarity import numpy_vec_distance
import numpy as np
...
class KMeans(object):
    ...
    def update_clusters(self):
        ...
        def closest_center_index(vector):
            ...
            similarity_to_vector = lambda center: numpy_vec_distance(np.array(center).reshape(1, -1), np.array(vector).reshape(-1, 1))
